...
# with command line options: mdsNano_raw_sim -s RAW2DIGI,RECO,PAT,NANO --mc --conditions 110X_mcRun3_2021_realistic_v6 --era Run3 --eventcontent NANOAOD --datatier NANOAOD --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=1000 -n 100 --no_exec
...
process.source = cms.Source("PoolSource",
    #fileNames = cms.untracked.vstring('file:mdsNano_raw_sim_DIGI2RAW.root'),
    fileNames = cms.untracked.vstring('root://cmseos.fnal.gov//store/mc/Run3Winter20DRPremixMiniAOD/HTo2LongLivedTo4b_MH-250_MFF-60_CTau-10000mm_TuneCP5_14TeV_pythia8/GEN-SIM-RAW/110X_mcRun3_2021_realistic_v6-v2/240000/5A3BC3A0-BFF8-9549-8824-D9D868E6BD9F.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('mdsNano_raw_sim nevts:100'),
...
process.NANOAODoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('mdsNano_raw_sim_RAW2DIGI_RECO_PAT_NANO.root'),
...
process.nanoAOD_step = cms.Path(process.nanoSequenceMC + process.cscRechitTable + process.mdsClusterTable )
